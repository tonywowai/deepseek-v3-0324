...
class MyModel(AIxBlockMLBase):
    ...
    def action(self,  command,**kwargs):
        ...
        if command.lower() == "train":
                ...
                model_id = kwargs.get("model_id", "deepseek-ai/DeepSeek-V3-0324")  #"tiiuae/falcon-7b" "bigscience/bloomz-1b7" `zanchat/falcon-1b` `appvoid/llama-3-1b` deepseek-ai/DeepSeek-V3-0324` `mistralai/Mistral-7B-v0.1` `bigscience/bloomz-1b7` `Qwen/Qwen2-1.5B`
            ...
            try:
                ...
                model_id = kwargs.get("model_id", "deepseek-ai/DeepSeek-V3-0324")
    ...
    def model(self, **kwargs):
        ...
        model_id = kwargs.get("model_id", "deepseek-ai/DeepSeek-V3-0324")
        # if "deepseek" not in "deepseek-ai/DeepSeek-V3-0324":
